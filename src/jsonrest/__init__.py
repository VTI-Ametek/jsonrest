...
class JSONREST(object):
    ...
    def get(self, uri):
        ...
        Returns:
            The message body of the response, converted from json to native python data types.
        '''
...
class VTIREST(JSONREST):
    ...
    def _check_error(self):
        ...
        Raises:
            VTIInstrumentError: The next item from the error queue, if any.
        '''
    ...
    def get(self, uri):
        ...
        Raises:
            VTIInstrumentError: When the HTTP status is 240, the next item in the instrument error queue will be raised as a child class of this type.
        '''
        resp = self._session.get(self._base + uri)
        resp.raise_for_status()
